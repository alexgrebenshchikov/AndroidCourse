...
import com.example.android_course.util.dpToPx
import com.example.android_course.util.getCompatColor
import com.example.android_course.util.inflate
...
class PostLikesView @JvmOverloads constructor(
    ...
    private var circleBorderPaint: Paint =
        Paint()
            .apply {
                color = context.getCompatColor(R.color.design_default_color_on_secondary)
